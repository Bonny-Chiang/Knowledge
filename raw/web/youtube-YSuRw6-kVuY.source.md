...
For deeper compilation, prefer adding one of these lightweight text sources:

1. manual title and description
2. transcript or subtitles
3. short human notes with timestamps
